...
The interaction between user, client and the services can be described in a series of stages.

\subsection{Discovery}
\label{discovery-stage}

The first stage in the process is the discovery stage, where the user selects the software and
\dataset{}s that they want to work with.
This involves interaction between the client application and the software and data discovery services.

The detailed specification for the discovery services is beyond the scope of this document.
However we can outline some general requirements for these services.
